OBJS = Attack.o Condition.o Container.o Creature.o Dungeon.o Handler.o Item.o main.o Room.o Thing.o Trigger.o XMLParser.o
...
CLASSES=tinystr.cpp tinyxml.cpp Attack.cpp Condition.cpp Container.cpp Creature.cpp Dungeon.cpp Handler.cpp Item.cpp Room.cpp Thing.cpp Trigger.cpp XMLParser.cpp
...
# Create a zip file with all relevant files to build the project
ZIPFILES=$(SOURCES) $(HEADERS) $(PROJECT_FILES) $(XML_FILES)
